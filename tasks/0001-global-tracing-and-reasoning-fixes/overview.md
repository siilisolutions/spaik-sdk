...
|------|-------|------|-------------|
| [001](001.md) | Add NoOpTraceSink and global tracing configuration | [ ] | Create NoOpTraceSink, add configure_tracing function, update get_trace_sink resolution logic |
